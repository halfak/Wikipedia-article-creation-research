...
svg("new_editors/plots/relative.funnel_props.dewiki.svg",
	width=7,
	height=7)
ggplot(
...
scale_y_continuous("Relative proportion") + 
...
svg("new_editors/plots/registered_users.counts.dewiki.svg",
	width=7,
	height=2)
ggplot(
	months[
...
geom_bar(fill="#CCCCCC", color="black", stat="identity") + 
scale_y_continuous("Newly registered users") + 
scale_x_date("Registration month") + 
theme_bw()
dev.off()

svg("new_editors/plots/new_editors.counts.dewiki.svg",
	width=7,
	height=2)
ggplot(
	months[
...
svg("new_editors/plots/new_page_creators.counts.dewiki.svg",
	width=7,
	height=2)
ggplot(
	months[
...
svg("new_editors/plots/new_article_creators.counts.dewiki.svg",
	width=7,
	height=2)
ggplot(
	months[
...
svg("new_editors/plots/new_draft_creators.counts.dewiki.svg",
	width=7,
	height=2)
ggplot(
	months[
